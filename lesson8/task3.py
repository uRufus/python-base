...
очередного элемента необходимо реализовать проверку типа элемента и
...
class NumberControlException(Exception):
...
while number != "stop":
    ...
    try:
        if number.isnumeric():
            ...
            raise NumberControlException("Вы ввели не число")
    except NumberControlException as num:
        print(num)
print(numbers)